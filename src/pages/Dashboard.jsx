    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          ...
          <p className="text-xl sm:text-2xl font-bold text-red-400">{formatCurrency(avgExpense)} {getCurrencySymbol(selectedCurrency)}</p>
        ...
        >
          ...
          <p className="text-xl sm:text-2xl font-bold text-emerald-400">{formatCurrency(avgIncome)} {getCurrencySymbol(selectedCurrency)}</p>
          <p className="text-xs text-slate-500 mt-1">per tranzacție</p>
        </motion.div>
      </div>
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-2">
          <h2 className="text-base sm:text-lg font-bold">Evoluție Ultimele 6 Luni</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          className="rounded-2xl bg-[#1A1D29] border border-[#2A2E3D] p-3 sm:p-6"
        >
          <h2 className="text-base sm:text-lg font-bold mb-4">Detalii Cheltuieli pe Categorie</h2>
        ...
        <motion.div
          ...
          className="rounded-2xl bg-[#1A1D29] border border-[#2A2E3D] p-3 sm:p-6"
        >
          <h2 className="text-base sm:text-lg font-bold mb-4">Detalii Venituri pe Categorie</h2>
      ...
      <motion.div
        ...
        className="rounded-2xl bg-[#1A1D29] border border-[#2A2E3D] p-3 sm:p-6"
      >
        <h2 className="text-base sm:text-lg font-bold mb-4">Tranzacții Recente</h2>
        {recentTx.length === 0 ? (
